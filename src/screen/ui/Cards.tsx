...
export const CardTitle = ({
  ...
  return <h4 className={cn("text-[#ddd] font-bold text-2xl tracking-wide mt-4", className)}>{children}</h4>
}
export const CardDescription = ({
  ...
  return <p className={cn("mt-8 text-[#bbb] tracking-wide leading-relaxed text-sm", className)}>{children}</p>
}
