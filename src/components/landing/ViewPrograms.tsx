...
export default function ViewPrograms() {
    return (
        <>
        <div className="relative fromScale rounded-2xl h-[400px] mb-8 ">
                        ...
                        <div className="flex relative z-10 font-medium gap-8 h-full backdrop-blur-s bg-black/40  px-4 flex-col justify-center items-center text-center">
