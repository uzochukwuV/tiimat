...
const Faculty = () => {
  return (
    <div className=' h-screen px-6 sm:px-10 md:px-16 lg:px-24 pb-8'>
  ...
  <ul className="flex flex-col w-full ">
    <li className="relative flex flex-col gap-4">
      ...
      <div className="flex items-center gap-4 ">
        ...
        <h5
          className="block font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-[var(--text-tertiary)]">
          Our Goals.
        </h5>
      </div>
      <div className="flex gap-4 pb-8">
        ...
        <div>
          <p className="block text-sm antialiased  leading-relaxed text-[var(--text-secondary)]">
...
<div className=" flex-1">
  <img src="https://images.pexels.com/photos/5428265/pexels-photo-5428265.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" className=" rounded-xl h-full max-h-[460px] object-cover" />
</div>
        </div>
    </div>
  )
