...
export function AdminLayout() {
    ...
    return <div className="absolute top-0 right-0  bg-slate-50 left-0 bottom-0 flex flex-col ">
      ...
      <div className="sm:grid sm:grid-cols-4 w-full flex-1 ">
        <div className=" col-span-1 flex overflow-scroll py-6 px-6 md:flex md:overflow-hidden md:flex-col md:gap-4 md: ">
         <div className=""><Link className=" min-w-40 text-center block text-black hover:underline md:text-start md:shadow md:px-6 md:py-1  " to={"/admin/course/edit/curriculum"}  >Add curriculum</Link></div> 
      ...
      <div className=" bg-slate-50 col-span-3 px-6 py-8">
      <Outlet />
      </div>
