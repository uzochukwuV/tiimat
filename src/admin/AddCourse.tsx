...
function AddCourse() {
    ...
    return (
        ...
        <input
          ...
          className=" px-6 flex-1  w-[80vw] block relative rounded-xl focus:outline-gray-300 ring ring-white  h-14  bg-[var(--background)]"
        />
                <button onClick={addcoursetofaculty}  disabled={loading} className=" mt-4 bg-black hover:opacity-90 px-4 h-14 rounded-xl text-white flex gap-1 justify-center items-center" >Add <span><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" fill="#fff" width="20" height="20" viewBox="0 0 48 48">
