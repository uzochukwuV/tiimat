        ...
        <>
         ...
         <h1 className=" -translate-y-8 text-3xl">Add Semester</h1>
            ...
            <label htmlFor="topics">Choose Course to add Semester</label>
                ...
                <button disabled={Loading} type="submit" className=" mt-4 bg-black hover:opacity-70 px-4 h-14 rounded-xl text-white flex gap-1 justify-center items-center" >Add <span><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" fill="#fff" width="20" height="20" viewBox="0 0 48 48">
