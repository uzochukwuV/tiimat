import Image from "../assets/faculty/chart.jpg";
  ...
  return (
    <div className=" min-h-screen h-full antialiased">
        <div className="relative clear-start h-[80vh] faculty-bg bg-cover bg-top bg-blend-screen bg-no-repeat" >
            ...
            <div className="h-full flex justify-start items-center px-24 relative">
                <div className=" max-w-2xl">
                    <h2 className=" text-5xl font-medium  text-white">
                        Explore Our Programmes
                    </h2>
                    <p className=" text-gray-100 text-base mt-4">We believe that everyone should have access to the limitless potential of opportunity.
